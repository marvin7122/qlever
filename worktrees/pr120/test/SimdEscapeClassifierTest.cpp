...
TEST(SimdEscapeClassifierTest, RecognizesOnlyFormatSpecificCharacters) {
  static_cast<void>(SimdEscapeClassifier::isEscapeCharacter<EscapeFormat::Csv>(','));
  static_cast<void>(!SimdEscapeClassifier::isEscapeCharacter<EscapeFormat::Turtle>(','));
  static_cast<void>(SimdEscapeClassifier::isEscapeCharacter<EscapeFormat::Tsv>('\t'));
  static_cast<void>(!SimdEscapeClassifier::isEscapeCharacter<EscapeFormat::Csv>('\t'));
}
