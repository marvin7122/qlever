...
class PolymorphicVocabulary {
 ...
 public:
  ...
  // If the underlying vocabulary provides an overload taking an
  // `ArenaVocabBatchBuilder`, delegate to it; otherwise fall back to the
  // single-argument `lookupBatch`.
