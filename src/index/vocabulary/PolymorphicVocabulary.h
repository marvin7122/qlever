...
class PolymorphicVocabulary {
 ...
 public:
  ...
  // underlying vocabulary supports it (compressed). Otherwise the words of the
  // underlying single-shot result are copied into `builder`. In both cases the
  // result is `builder` finalized.
