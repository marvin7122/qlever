...
// Serialize one parameter pack of values according to a compile-time schema.
// The class does not perform runtime schema dispatch; callers select a concrete
// instantiation before entering the row loop.
