...
class ValidityBitmask64 {
 ...
 public:
  ...
  // Row-level query and manipulation. These stay non-`constexpr` because
  // the `AD_*_CHECK` bounds enforcement is not usable in constant
  // evaluation (`-Werror=invalid-constexpr`).
