...
// The batch scanners reinterpret `ValueId` storage as `uint64_t` words (the
// established `IdTable` raw-view practice). Pin the layout assumption this
// relies on: identical size and at least 8-byte alignment.
