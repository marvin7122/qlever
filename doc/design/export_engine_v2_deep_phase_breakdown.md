...
### 3. Performance Rationale
* **Reduced DRAM Traffic:** V2 avoids materializing and rereading the complete `IdTable`; chunk working sets are bounded to 64 KB, although source-data and cache-eviction accesses can still reach DRAM.
