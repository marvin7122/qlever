...
### 3. Performance Rationale
* **Intermediate Buffer Traffic:** V2 avoids materializing and rereading the full result `IdTable`; the remaining index reads, decompression, and output-buffer traffic are workload- and cache-dependent.
...
* **Planned validation:** Test 128B to 4096B literal sizes and record the benchmark exit status.
