...
4. **Single-Core Discipline:** The single query worker thread cooperatively interleaves computation with non-blocking I/O; computation and I/O are not executed concurrently by that thread.
