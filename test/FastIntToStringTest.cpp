...
TEST(FastIntToStringTest, NumDigitsUInt64) {
  EXPECT_EQ(numDigits(uint64_t{0}), 1U);
  EXPECT_EQ(numDigits(uint64_t{1}), 1U);
  EXPECT_EQ(numDigits(uint64_t{9}), 1U);
  EXPECT_EQ(numDigits(uint64_t{10}), 2U);
  EXPECT_EQ(numDigits(uint64_t{99}), 2U);
  EXPECT_EQ(numDigits(uint64_t{100}), 3U);
  EXPECT_EQ(numDigits(uint64_t{999}), 3U);
  EXPECT_EQ(numDigits(uint64_t{1000}), 4U);
  EXPECT_EQ(numDigits(uint64_t{9999}), 4U);
  EXPECT_EQ(numDigits(uint64_t{10000}), 5U);
  EXPECT_EQ(numDigits(uint64_t{99999}), 5U);
  EXPECT_EQ(numDigits(uint64_t{100000}), 6U);
  EXPECT_EQ(numDigits(uint64_t{999999}), 6U);
  EXPECT_EQ(numDigits(uint64_t{1000000}), 7U);
  EXPECT_EQ(numDigits(uint64_t{9999999}), 7U);
  EXPECT_EQ(numDigits(uint64_t{10000000}), 8U);
  EXPECT_EQ(numDigits(uint64_t{99999999}), 8U);
  EXPECT_EQ(numDigits(uint64_t{100000000}), 9U);
  EXPECT_EQ(numDigits(uint64_t{999999999}), 9U);
  EXPECT_EQ(numDigits(uint64_t{1000000000}), 10U);
  EXPECT_EQ(numDigits(uint64_t{9999999999}), 10U);
  EXPECT_EQ(numDigits(uint64_t{10000000000}), 11U);
  EXPECT_EQ(numDigits(uint64_t{99999999999}), 11U);
  EXPECT_EQ(numDigits(uint64_t{100000000000}), 12U);
  EXPECT_EQ(numDigits(uint64_t{999999999999}), 12U);
  EXPECT_EQ(numDigits(uint64_t{1000000000000}), 13U);
  EXPECT_EQ(numDigits(uint64_t{9999999999999}), 13U);
  EXPECT_EQ(numDigits(uint64_t{10000000000000}), 14U);
  EXPECT_EQ(numDigits(uint64_t{99999999999999}), 14U);
  EXPECT_EQ(numDigits(uint64_t{100000000000000}), 15U);
  EXPECT_EQ(numDigits(uint64_t{999999999999999}), 15U);
  EXPECT_EQ(numDigits(uint64_t{1000000000000000}), 16U);
  EXPECT_EQ(numDigits(uint64_t{9999999999999999}), 16U);
  EXPECT_EQ(numDigits(uint64_t{10000000000000000}), 17U);
  EXPECT_EQ(numDigits(uint64_t{99999999999999999}), 17U);
