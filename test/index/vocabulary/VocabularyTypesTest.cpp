...
//
// Note that UFR stands for the University of Freiburg, Chair of Algorithms and Data Structures.
//
...
// Define a class that executes a passed function in its constructor.
class Caller {
 public:
...
// _____________________________________________________________________________
// Define a class inheriting from `WordWriterBase` that doesn't call finish.
