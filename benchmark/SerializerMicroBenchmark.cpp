...
// Global scalar new/delete instrumentation for allocation counting during benchmark runs. Used by benchmarks that generate a configurable number of triples.
